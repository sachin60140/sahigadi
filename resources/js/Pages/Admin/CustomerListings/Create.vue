    ...
    <AdminLayout title="Create Customer Listing" eyebrow="Customer inventory">
        <section class="mb-5 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wide text-teal-700">Manual listing</p>
                    <h2 class="mt-2 text-3xl font-semibold text-slate-950">Add a customer car listing.</h2>
