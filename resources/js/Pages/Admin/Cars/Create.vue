    ...
    <AdminLayout title="Add New Car" eyebrow="Inventory operations">
        <section class="mb-5 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    <p class="text-xs font-black uppercase tracking-wide text-teal-700">Create listing</p>
                    <h2 class="mt-2 text-3xl font-black text-slate-950">Add a dealer car manually.</h2>
