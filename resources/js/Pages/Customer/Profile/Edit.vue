            ...
            <section class="grid gap-5 lg:grid-cols-[300px_1fr]">
                <aside class="space-y-5">
                    <div class="rounded-lg border border-slate-200 bg-white p-5 text-center shadow-sm">
                        ...
                        <h2 class="mt-4 text-lg font-semibold text-slate-950">{{ customer.name || 'Customer' }}</h2>
                        <p class="mt-1 text-sm font-bold text-slate-500">+91 {{ customer.phone }}</p>
                        <p class="mt-2 text-xs font-semibold text-teal-700">{{ customer.customer_unique_id }}</p>
                    </div>

                    <div class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                        <div class="flex items-center justify-between gap-3">
                            <p class="text-sm font-semibold text-slate-950">Profile completion</p>
                            <span class="text-sm font-semibold" :class="customer.profile_completion_percentage >= 75 ? 'text-teal-700' : 'text-orange-700'">
                        ...
                        <div v-if="customer.missing_fields.length" class="mt-4">
                            <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">Still missing</p>
                ...
                <form class="rounded-lg border border-slate-200 bg-white shadow-sm" @submit.prevent="submit">
                    <div class="border-b border-slate-100 px-5 py-4 sm:px-6">
                        <p class="text-xs font-semibold uppercase tracking-wide text-teal-700">Personal information</p>
                        <h2 class="mt-1 text-xl font-semibold text-slate-950">Keep your account up to date</h2>
                    </div>

                    <div class="space-y-7 p-5 sm:p-6">
                        <section>
                            <h3 class="text-sm font-semibold text-slate-950">Profile and contact</h3>
                        ...
                        <section class="border-t border-slate-100 pt-6">
                            <h3 class="text-sm font-semibold text-slate-950">Identity</h3>
                        ...
                        <section class="border-t border-slate-100 pt-6">
                            <h3 class="text-sm font-semibold text-slate-950">Address and business</h3>
                            <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    ...
                    <div class="flex flex-col-reverse gap-3 border-t border-slate-100 px-5 py-4 sm:flex-row sm:justify-end sm:px-6">
                        ...
                        <button class="rounded-lg bg-teal-700 px-5 py-3 text-sm font-semibold text-white hover:bg-teal-800 disabled:opacity-50" :disabled="form.processing">
