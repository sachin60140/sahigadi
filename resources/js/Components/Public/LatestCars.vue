    ...
    <section v-if="cars && cars.length > 0" class="bg-white py-14 md:py-20">
        <div class="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
            <div class="mb-9 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
                <div>
                    <p class="mb-2 text-sm font-black uppercase tracking-[0.16em] text-teal-700">Fresh inventory</p>
                    <h2 class="text-3xl font-black tracking-normal text-slate-950 md:text-4xl">Recently Added Cars</h2>
