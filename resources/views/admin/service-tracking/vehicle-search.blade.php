...
@section('title', 'Service Tracking - RC Search - SAHI GADI Admin')
...
<div class="card">
    <div class="card-header bg-white">
        <form action="{{ route('admin.service-tracking.vehicle-search') }}" method="GET" class="row g-2">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                ...
                <a href="{{ route('admin.service-tracking.vehicle-search') }}" class="btn btn-outline-secondary">Clear</a>
            </div>
        </form>
    </div>
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $search->registration_number ?? $search->vehicle_number ?? 'N/A' }}</td>
                        <td>
