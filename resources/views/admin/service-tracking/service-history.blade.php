...
@section('title', 'Service Tracking - Service History - SAHI GADI Admin')
...
<div class="card">
    <div class="card-header bg-white">
        <form action="{{ route('admin.service-tracking.service-history') }}" method="GET" class="row g-2">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                ...
                <a href="{{ route('admin.service-tracking.service-history') }}" class="btn btn-outline-secondary">Clear</a>
            </div>
        </form>
    </div>
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>₹{{ number_format($search->paid_amount ?? 0) }}</td>
