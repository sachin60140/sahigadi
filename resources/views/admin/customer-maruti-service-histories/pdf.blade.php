...
@section('doc-title', 'Customer Maruti Service Histories - SAHI GADI')
@section('brand-subtitle', 'Admin operations')
@section('report-kicker', 'Admin export')
@section('report-title', 'Customer Maruti Service Histories')
...
@section('content')
    ...
    <div class="section">
        <table class="section-heading"><tr><td class="section-title">Customer Maruti lookups</td><td class="section-caption">{{ $searches->count() }} entries</td></tr></table>
