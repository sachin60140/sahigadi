        ...
        <div class="kpi-card h-100 border-start border-primary border-4">
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <h2 class="fw-800 mb-0 text-primary">₹{{ number_format($stats['dealer_wallet_balance']) }}</h2>
        ...
        <div class="kpi-card h-100 border-start border-info border-4">
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <h2 class="fw-800 mb-0 text-info">₹{{ number_format($stats['customer_wallet_balance']) }}</h2>
                    <p class="mb-0 mt-2 mini-stat text-muted">Available Balances</p>
                </div>
                <div class="kpi-icon-wrapper bg-info-soft">
        ...
        <div class="kpi-card h-100 border-start border-warning border-4">
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <h2 class="fw-800 mb-0 text-warning">{{ number_format($stats['total_customers']) }}</h2>
                    <p class="mb-0 mt-2 mini-stat text-warning"><i class="bi bi-person-plus-fill me-1"></i>+{{ $stats['today_customers'] }} Today</p>
                </div>
        ...
        <div class="kpi-card h-100 border-start border-success border-4">
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <h2 class="fw-800 mb-0 text-success">{{ number_format($stats['today_dealers']) }}</h2>
