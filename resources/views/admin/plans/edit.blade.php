            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $plan->price) }}" min="0" step="0.01" required>
                        @error('price')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" name="listing_limit" class="form-control @error('listing_limit') is-invalid @enderror" value="{{ old('listing_limit', $plan->listing_limit) }}" min="1" required>
                        @error('listing_limit')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-12">
                    <div class="form-check">
                        <input type="checkbox" name="is_active" class="form-check-input" id="is_active" value="1" {{ old('is_active', $plan->is_active) ? 'checked' : '' }}>
