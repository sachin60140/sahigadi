    ...
    <div class="card-body">
        <form action="{{ route('admin.customer-wallet-recharges.index') }}" method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-2">
                ...
                <a href="{{ route('admin.customer-wallet-recharges.index') }}" class="btn btn-light flex-grow-1 px-2 text-center">Clear</a>
            </div>
        </form>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <span class="badge bg-secondary" style="font-size: 0.65rem;">{{ $txn->wallet->customer->customer_unique_id ?? 'N/A' }}</span>
                                </div>
                                <div class="d-flex align-items-center gap-2 mb-1">
