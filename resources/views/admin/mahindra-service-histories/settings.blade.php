...
@section('title', 'Mahindra Service History Settings - SAHI GADI Admin')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-gear me-2"></i>Mahindra Service History Settings</h2>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.mahindra-service-histories.settings') }}">
                    @csrf
                    <div class="mb-3">
