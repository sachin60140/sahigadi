...
@section('doc-title', 'Customer Mahindra Service Histories - SAHI GADI')
@section('brand-subtitle', 'Admin operations')
@section('report-kicker', 'Admin export')
@section('report-title', 'Customer Mahindra Service Histories')
...
@section('content')
    ...
    <div class="section">
        <table class="section-heading"><tr><td class="section-title">Customer Mahindra lookups</td><td class="section-caption">{{ $searches->count() }} entries</td></tr></table>
        <table class="data-table">
            <thead>
                <tr><td>ID</td><td>Customer</td><td>Phone</td><td>Vehicle number</td><td class="num">Charge paid</td><td>Status</td><td>Date</td></tr>
            </thead>
            <tbody>
