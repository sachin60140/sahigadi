...
@section('title', 'RC Search Settings - SAHI GADI Admin')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-gear me-2"></i>RC Search Settings</h2>
    <a href="{{ route('admin.vehicle-searches.index') }}" class="btn btn-outline-secondary">
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.vehicle-searches.settings') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Customer Charge (₹)</label>
                            <input type="number" name="charge" class="form-control" 
                                   value="{{ $charge }}" min="0" step="0.01" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="dealer_charge" class="form-control" 
                                   value="{{ $dealerCharge }}" min="0" step="0.01" required>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <div class="p-3 bg-light rounded text-center">
                            <h3 class="mb-0 text-primary">{{ $totalSearches }}</h3>
                            <small class="text-muted">Total Searches</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 bg-light rounded text-center">
                            <h3 class="mb-0 text-success">{{ $successfulSearches }}</h3>
