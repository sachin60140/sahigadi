...
@section('title', 'Service History Reports - SAHI GADI Admin')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-wrench me-2"></i>Service History Reports</h2>
    <div class="d-flex gap-2">
        <a href="{{ route('admin.service-histories.settings') }}" class="btn btn-outline-primary">
    ...
    <div class="col-md-3">
        <div class="kpi-card">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    <h3 class="mb-0">{{ $searches->where('is_success', true)->count() }}</h3>
...
<div class="card">
    <div class="card-header bg-white">
        <div class="row g-3">
            <div class="col-md-12">
                <form action="{{ route('admin.service-histories.index') }}" method="GET" class="row g-2">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('admin.service-histories.index') }}" class="btn btn-outline-secondary">Clear</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12">
                <div class="btn-group">
                    <a href="{{ route('admin.service-histories.exportExcel', request()->query()) }}" class="btn btn-success">
                        <i class="bi bi-file-earmark-excel me-1"></i>Export Excel
                    </a>
                    <a href="{{ route('admin.service-histories.exportPdf', request()->query()) }}" class="btn btn-danger">
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $search->service_count ?? 0 }} Records</td>
                        <td>₹{{ number_format($search->charge_amount, 2) }}</td>
                        <td>{{ $search->created_at->format('d M Y') }}</td>
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('admin.service-histories.show', $search) }}" class="btn btn-outline-primary">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('admin.service-histories.downloadPdf', $search) }}" class="btn btn-outline-danger">
