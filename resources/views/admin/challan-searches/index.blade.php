...
@section('title', 'E-Challan Reports - SAHI GADI Admin')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-receipt me-2"></i>E-Challan Reports</h2>
    <div class="d-flex gap-2">
        <a href="{{ route('admin.challan-searches.settings') }}" class="btn btn-outline-primary">
...
<div class="card">
    <div class="card-header bg-white">
        <div class="row g-3">
            <div class="col-md-12">
                <form action="{{ route('admin.challan-searches.index') }}" method="GET" class="row g-2">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('admin.challan-searches.index') }}" class="btn btn-outline-secondary">Clear</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12">
                <div class="btn-group">
                    <a href="{{ route('admin.challan-searches.exportExcel', request()->query()) }}" class="btn btn-success">
                        <i class="bi bi-file-earmark-excel me-1"></i>Export Excel
                    </a>
                    <a href="{{ route('admin.challan-searches.exportPdf', request()->query()) }}" class="btn btn-danger">
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>₹{{ number_format($search->total_amount ?? 0, 2) }}</td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('admin.challan-searches.show', $search) }}" class="btn btn-outline-primary">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </div>
                        </td>
