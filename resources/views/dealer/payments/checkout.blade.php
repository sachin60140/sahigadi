...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                @if($isRazorpayActive)
                <form id="razorpay-form" action="{{ route('dealer.payments.success') }}" method="POST" class="mb-3">
                    @csrf
                ...
                @if($isPhonePeActive)
                <form id="phonepe-form" action="{{ route('dealer.payments.phonepe.initiate') }}" method="POST">
                    @csrf
