...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('dealer.service-history.search') }}" method="POST">
            @csrf
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('dealer.service-history.index') }}" method="GET" class="d-flex gap-2">
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $search->records->count() ?? 0 }} Records</td>
                        <td>
                        ...
                        <td>₹{{ number_format($search->debit_amount, 2) }}</td>
                        <td>{{ $search->created_at->format('d M Y, h:i A') }}</td>
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('dealer.service-history.show', $search) }}" class="btn btn-outline-primary">
                                    <i class="bi bi-eye"></i>
                                </a>
                                @if($search->is_success)
                                <a href="{{ route('dealer.service-history.pdf', $search) }}" class="btn btn-outline-danger">
