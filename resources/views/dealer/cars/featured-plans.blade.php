...
@section('title', 'Promote Your Car')
        ...
        <div class="col-lg-10">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    <a href="{{ route('dealer.cars.index') }}" class="btn btn-light btn-sm me-3 border shadow-sm">
                        <i class="bi bi-arrow-left"></i>
                    </a>
                    <div>
                        <h3 class="mb-0 text-gray-800">Promote "{{ $car->model }}"</h3>
                ...
                <div class="text-end d-none d-md-block">
                    ...
                    <h4 class="mb-0 text-primary">₹{{ number_format(auth('dealer')->user()->wallet->balance ?? 0, 2) }}</h4>
                </div>
            </div>
            ...
            <div class="alert alert-warning border-0 shadow-sm d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="mb-0">This car is featured until <strong>{{ $car->featured_expires_at->format('d M Y, h:i A') }}</strong>.</p>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm position-relative feature-plan-card" style="transition: transform 0.3s ease;">
                        ...
                        <div class="card-body text-center p-5">
                            ...
                            <form action="{{ route('dealer.cars.featured-purchase', $car) }}" method="POST" class="purchase-form no-loader">
                                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const walletBalance = {{ auth('dealer')->user()->wallet->balance ?? 0 }};
            ...
            if (price > walletBalance) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "{{ route('dealer.wallet.index') }}";
                    }
                });
                return;
            }
