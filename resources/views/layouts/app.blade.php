        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-3"><a href="{{ route('cars.index') }}" class="footer-link">Browse Cars</a></li>
                        <li class="mb-3"><a href="{{ route('dealer.register') }}" class="footer-link">Become a Dealer</a></li>
                        <li class="mb-3"><a href="{{ route('contact') }}" class="footer-link">Contact Us</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <h6 class="footer-heading">Popular Brands</h6>
                    <ul class="list-unstyled">
                        <li class="mb-3"><a href="{{ route('cars.brand', 'maruti-suzuki') }}" class="footer-link">Maruti Suzuki</a></li>
                        <li class="mb-3"><a href="{{ route('cars.brand', 'hyundai') }}" class="footer-link">Hyundai</a></li>
                        <li class="mb-3"><a href="{{ route('cars.brand', 'tata') }}" class="footer-link">Tata Motors</a></li>
                        <li class="mb-3"><a href="{{ route('cars.brand', 'mahindra') }}" class="footer-link">Mahindra</a></li>
                    </ul>
                </div>
            ...
            <div class="row align-items-center pb-2">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <p class="footer-text mb-0">&copy; {{ date('Y') }} SAHI GADI. All rights reserved.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <div class="d-inline-flex flex-wrap justify-content-center gap-3">
                        <a href="{{ route('privacy-policy') }}" class="footer-link fs-6">Privacy Policy</a>
                        <a href="{{ route('terms-of-use') }}" class="footer-link fs-6">Terms of Use</a>
                        <a href="{{ route('refund-policy') }}" class="footer-link fs-6">Refund Policy</a>
                    </div>
                </div>
            </div>
        </div>
