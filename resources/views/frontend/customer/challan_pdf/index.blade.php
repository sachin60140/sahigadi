        ...
        <div class="col-md-9">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('customer.challan-pdf.history') }}" class="btn btn-sm btn-light text-primary">View History</a>
                </div>
                <div class="card-body p-4">

                    <div class="alert alert-info">
                        <i class="bi bi-info-circle me-2"></i>
                        <strong>Note:</strong> Charge per search is ₹{{ \App\Models\Setting::getChallanPdfCharge() }}. 
                        Amount will be deducted from your wallet only on successful PDF generation.
                    </div>

                    <form action="{{ route('customer.challan-pdf.search') }}" method="POST">
                        @csrf
                        <div class="mb-4">
