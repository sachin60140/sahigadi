...
<section class="py-4" style="background: linear-gradient(135deg, var(--primary) 0%, var(--secondary) 100%);">
    <div class="container">
        ...
        <div class="text-white">
            ...
            <p class="mb-0">Browse {{ $dealers->total() }} trusted and verified car dealers</p>
        </div>
    </div>
</section>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                ...
                                @endif
                                @if($dealer->city)
                                    <p class="text-muted small mb-2"><i class="bi bi-geo-alt me-1"></i>{{ $dealer->city }}</p>
                                @endif
                            </div>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                @elseif($dealer->email_verified_at)
                                    <span class="badge bg-info me-1"><i class="bi bi-check-circle me-1"></i>Email Verified</span>
                                @endif
                                <span class="text-muted small">{{ $dealer->approved_cars_count ?? 0 }} cars</span>
                            </div>
                            <a href="{{ route('dealer.catalog', $dealer->slug) }}" class="btn btn-sm btn-outline-primary">
                                View Inventory <i class="bi bi-arrow-right ms-1"></i>
                            </a>
                        </div>
                        @if($dealer->phone)
                        <div class="mt-3">
                            <a href="tel:{{ $dealer->phone }}" class="btn btn-sm btn-success w-100">
