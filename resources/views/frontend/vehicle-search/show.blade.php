...
@section('title', 'RC Search Result - SAHI GADI')
    ...
    <div class="row {{ !auth('customer')->check() ? 'justify-content-center' : '' }}">
        ...
        <div class="{{ auth('customer')->check() ? 'col-lg-9' : 'col-lg-10' }}">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('vehicle-search.index') }}" class="btn btn-outline-primary me-2">
                    <i class="bi bi-arrow-left me-2"></i>Back to Search
                </a>
                @if($vehicleSearch->is_success)
                <a href="{{ route('vehicle-search.pdf', $vehicleSearch->id) }}" class="btn btn-danger">
