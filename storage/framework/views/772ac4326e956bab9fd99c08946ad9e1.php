<?php $__env->startSection('title', 'E-Challan Reports - SAHIGADI Admin'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-receipt me-2"></i>E-Challan Reports</h2>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('admin.challan-searches.settings')); ?>" class="btn btn-outline-primary">
...
<div class="card">
    <div class="card-header bg-white">
        <div class="row g-3">
            <div class="col-md-12">
                <form action="<?php echo e(route('admin.challan-searches.index')); ?>" method="GET" class="row g-2">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="<?php echo e(route('admin.challan-searches.index')); ?>" class="btn btn-outline-secondary">Clear</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12">
                <div class="btn-group">
                    <a href="<?php echo e(route('admin.challan-searches.exportExcel', request()->query())); ?>" class="btn btn-success">
                        <i class="bi bi-file-earmark-excel me-1"></i>Export Excel
                    </a>
                    <a href="<?php echo e(route('admin.challan-searches.exportPdf', request()->query())); ?>" class="btn btn-danger">
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>₹<?php echo e(number_format($search->total_amount ?? 0, 2)); ?></td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="<?php echo e(route('admin.challan-searches.show', $search)); ?>" class="btn btn-outline-primary">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </div>
                        </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/admin/challan-searches/index.blade.php ENDPATH**/ ?>