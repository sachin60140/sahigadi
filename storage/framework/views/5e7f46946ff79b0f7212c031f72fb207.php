<?php $__env->startSection('title', 'E-Challan Check - SAHIGADI'); ?>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-lg">
                <div class="card-body p-5">
                    ...
                    <form action="<?php echo e(route('challan-search.search')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\frontend\challan-search\index.blade.php ENDPATH**/ ?>