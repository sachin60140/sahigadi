...
<head>
    ...
    <link rel="image_src" href="<?php echo $__env->yieldContent('og_image', asset('images/og-image.png')); ?>">
    ...
    <meta itemprop="name" content="<?php echo $__env->yieldContent('og_title', 'SAHI GADI - Used Car Marketplace'); ?>">
    <meta itemprop="description" content="<?php echo $__env->yieldContent('og_description', 'Find verified pre-owned cars in Patna, Bihar'); ?>">
    <meta itemprop="image" content="<?php echo $__env->yieldContent('og_image', asset('images/og-image.png')); ?>">
