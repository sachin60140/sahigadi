<?php $__env->startSection('title', 'RC Search Reports - SAHI GADI Admin'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-search me-2"></i>RC Search Reports</h2>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('admin.vehicle-searches.settings')); ?>" class="btn btn-outline-primary">
...
<div class="card">
    <div class="card-header bg-white">
        <div class="row g-3">
            <div class="col-md-12">
                <form action="<?php echo e(route('admin.vehicle-searches.index')); ?>" method="GET" class="row g-2">
                    <div class="col-md-2">
                        <input type="text" name="search" class="form-control" placeholder="Reg Number..." value="<?php echo e(request('search')); ?>">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="<?php echo e(route('admin.vehicle-searches.index')); ?>" class="btn btn-outline-secondary">Clear</a>
                    </div>
                </form>
            </div>
            <div class="col-md-12">
                <div class="btn-group">
                    <a href="<?php echo e(route('admin.vehicle-searches.exportExcel', request()->query())); ?>" class="btn btn-success">
                        <i class="bi bi-file-earmark-excel me-1"></i>Export Excel
                    </a>
                    <a href="<?php echo e(route('admin.vehicle-searches.exportPdf', request()->query())); ?>" class="btn btn-danger">
        ...
        <div class="table-responsive">
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="fw-bold"><?php echo e($search->registration_number); ?></td>
                        <td><?php echo e(Str::limit($search->owner_name ?? 'N/A', 20)); ?></td>
                        <td><?php echo e($search->dealer->name ?? 'N/A'); ?></td>
                        <td><?php echo e(Str::limit(($search->make ?? '') . ' ' . ($search->model ?? ''), 25)); ?></td>
                        <td>
                            <?php if($search->is_success): ?>
                                <span class="badge bg-success"><?php echo e($search->rc_status ?? 'Active'); ?></span>
                            <?php else: ?>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="<?php echo e(route('admin.vehicle-searches.show', $search)); ?>" class="btn btn-outline-primary">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="<?php echo e(route('admin.vehicle-searches.downloadPdf', $search)); ?>" class="btn btn-outline-danger">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/admin/vehicle-searches/index.blade.php ENDPATH**/ ?>