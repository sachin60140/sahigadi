...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <?php if($isRazorpayActive): ?>
                <form id="razorpay-form" action="<?php echo e(route('dealer.payments.success')); ?>" method="POST" class="mb-3">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="razorpay_order_id" id="razorpay_order_id" value="<?php echo e($order['order_id'] ?? ''); ?>">
                    <input type="hidden" name="razorpay_payment_id" id="razorpay_payment_id">
                    <input type="hidden" name="razorpay_signature" id="razorpay_signature">
                    <input type="hidden" name="amount" value="<?php echo e($amount * 100); ?>">
                    ...
                    <button type="button" id="rzp-button" class="btn btn-primary btn-lg w-100 mb-2">
                        <i class="bi bi-credit-card"></i> Pay ₹<?php echo e(number_format($amount, 2)); ?> with Razorpay
                    </button>
                </form>
                <?php endif; ?>

                <?php if($isPhonePeActive): ?>
                <form id="phonepe-form" action="<?php echo e(route('dealer.payments.phonepe.initiate')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <button type="submit" class="btn btn-success btn-lg w-100">
                        <i class="bi bi-phone"></i> Pay ₹<?php echo e(number_format($amount, 2)); ?> with PhonePe
                    </button>
                </form>
                <?php endif; ?>
            </div>
...
var options = {
    ...
    "amount": <?php echo e(($order['amount'] ?? 0) * 100); ?>,
    "currency": "INR",
    "name": "CarMarket",
