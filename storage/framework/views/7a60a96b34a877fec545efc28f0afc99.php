...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><strong><?php echo e($search->registration_number); ?></strong></td>
                <td><?php echo e($search->owner_name ?? 'N/A'); ?></td>
                <td><?php echo e($search->dealer->name ?? 'N/A'); ?></td>
                <td><?php echo e(($search->make ?? '') . ' ' . ($search->model ?? '')); ?></td>
                <td>
                    <?php if($search->is_success): ?>
                        <span class="badge badge-success"><?php echo e($search->rc_status ?? 'Active'); ?></span>
                    <?php else: ?>
                        <span class="badge badge-danger">Failed</span>
                    <?php endif; ?>
                </td>
                <td>Rs. <?php echo e(number_format($search->charge_amount, 2)); ?></td>
...
<?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\admin\vehicle-searches\pdf.blade.php ENDPATH**/ ?>