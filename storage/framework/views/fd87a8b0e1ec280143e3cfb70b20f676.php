<?php $__env->startSection('title', 'Manage Cars - SAHI GADI Admin'); ?>
...
<div class="stat-card mb-4">
    <form action="<?php echo e(route('admin.cars.index')); ?>" method="GET" class="row g-3">
        ...
        <div class="col-md-4 d-flex gap-2">
            ...
            <a href="<?php echo e(route('admin.cars.index')); ?>" class="btn btn-outline-secondary text-center">Clear</a>
        </div>
    </form>
</div>
    ...
    <table class="table mb-0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('admin.cars.show', $car)); ?>" class="btn btn-sm btn-outline-primary me-1" title="View">
                        <i class="bi bi-eye"></i>
                    </a>
                    <a href="<?php echo e(route('admin.cars.edit', $car)); ?>" class="btn btn-sm btn-outline-secondary me-1" title="Edit">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('admin.cars.destroy', $car)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this car?');">
                        <?php echo csrf_field(); ?>
