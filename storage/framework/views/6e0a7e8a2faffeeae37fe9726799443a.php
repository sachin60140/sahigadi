<?php $__env->startSection('title', 'Terms of Use - SAHIGADI'); ?>
        ...
        <div class="col-lg-10">
            <div class="card border-0 shadow-lg">
                <div class="card-body p-5">
                    ...
                    <p class="text-muted mb-4">Last Updated: <?php echo e(date('F d, Y')); ?></p>
                    ...
                    <h4 class="fw-bold mb-3">4. Dealer Responsibilities</h4>
                    <p class="mb-2">If you register as a dealer, you agree to:</p>
                    <ul class="mb-4">
                        <li>Provide accurate information about vehicles listed for sale</li>
                        <li>Ensure all vehicle listings comply with applicable laws and regulations</li>
                        <li>Respond promptly to customer enquiries</li>
                        <li>Maintain valid business credentials and licenses</li>
                        <li>Honor all transactions and commitments made through the platform</li>
                    </ul>

                    <h4 class="fw-bold mb-3">5. Prohibited Activities</h4>
                    ...
                    <ul class="mb-4">
                        <li>Be for vehicles that actually exist and are available for sale</li>
                        <li>Include accurate descriptions, specifications, and pricing</li>
                        <li>Have clear, representative photographs</li>
                        <li>Disclose any known defects or issues</li>
                        <li>Comply with all applicable motor vehicle regulations</li>
                    </ul>
                    ...
                    <p class="mb-4">These Terms of Use shall be governed by and construed in accordance with the laws of India, specifically the laws of Bihar.</p>

                    <h4 class="fw-bold mb-3">13. Changes to Terms</h4>
                    <p class="mb-4">We may modify these Terms of Use at any time. Your continued use of the platform after any such modification constitutes your acceptance of the new terms.</p>

                    <h4 class="fw-bold mb-3">14. Contact Information</h4>
                    <p class="mb-0">For questions about these Terms of Use, please contact us at support@sahigadi.com</p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\frontend\pages\terms-of-use.blade.php ENDPATH**/ ?>