<?php $__env->startSection('title', 'Service Tracking - E-Challan - SAHIGADI Admin'); ?>
...
<div class="card">
    <div class="card-header bg-white">
        <form action="<?php echo e(route('admin.service-tracking.challan-search')); ?>" method="GET" class="row g-2">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                ...
                <a href="<?php echo e(route('admin.service-tracking.challan-search')); ?>" class="btn btn-outline-secondary">Clear</a>
            </div>
        </form>
    </div>
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>₹<?php echo e(number_format($search->charge_amount ?? $search->paid_amount ?? 0)); ?></td>
                        <td><?php echo e($search->created_at->format('d M Y H:i')); ?></td>
                        <td>
                            <a href="<?php echo e(route('admin.service-tracking.challan-search.show', ['id' => $search->id, 'type' => $search->type])); ?>" class="btn btn-sm btn-outline-primary" title="View Details"><i class="bi bi-eye"></i></a>
                            <?php if($search->is_success): ?>
                                <a href="<?php echo e(route('admin.service-tracking.challan-search.pdf', ['id' => $search->id, 'type' => $search->type])); ?>" class="btn btn-sm btn-outline-danger" title="Download PDF"><i class="bi bi-file-pdf"></i></a>
                            <?php endif; ?>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\admin\service-tracking\challan-search.blade.php ENDPATH**/ ?>