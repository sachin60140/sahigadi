...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('dealer.maruti-service-history.search')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <form action="<?php echo e(route('dealer.maruti-service-history.index')); ?>" method="GET" class="d-flex gap-2">
                <input type="text" name="search" class="form-control" placeholder="Search by reg number..." value="<?php echo e(request('search')); ?>">
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($search->records->count()); ?></td>
                        <td>
                        ...
                        <td>₹<?php echo e(number_format($search->debit_amount ?? 0, 2)); ?></td>
                        <td><?php echo e($search->created_at->format('d M Y, h:i A')); ?></td>
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="<?php echo e(route('dealer.maruti-service-history.show', $search)); ?>" class="btn btn-outline-primary">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <?php if($search->is_success): ?>
                                <a href="<?php echo e(route('dealer.maruti-service-history.pdf', $search)); ?>" class="btn btn-outline-danger">
...
<?php echo $__env->make('layouts.dealer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/dealer/maruti-service-history/index.blade.php ENDPATH**/ ?>