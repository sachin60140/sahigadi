<?php $__env->startSection('title', 'My Profile - SAHIGADI'); ?>
        ...
        <div class="profile-header"></div>
            ...
            <div class="profile-avatar-wrapper mb-4">
                ...
                <div class="ms-4 pb-2">
                    ...
                    <p class="text-muted mb-0"><i class="bi bi-buildings me-1"></i> <?php echo e($dealer->company_name ?? 'Independent Dealer'); ?></p>
                </div>
            </div>
