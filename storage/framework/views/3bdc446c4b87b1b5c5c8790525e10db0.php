    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.wallet-recharges.index')); ?>" method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-2">
                ...
                <a href="<?php echo e(route('admin.wallet-recharges.index')); ?>" class="btn btn-light flex-grow-1 px-2 text-center">Clear</a>
            </div>
        </form>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <span class="badge bg-secondary" style="font-size: 0.65rem;"><?php echo e($txn->wallet->dealer->dealer_unique_id ?? 'N/A'); ?></span>
                                </div>
                                <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                <div class="d-flex flex-column align-items-start">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="mt-1 w-100">
                                            ...
                                            <?php if($orderId): ?>
                                                <small class="user-select-all text-secondary d-block text-break" style="font-size:0.75rem;"><strong class="text-dark"><?php echo e(str_starts_with($txn->reference_id, 'PP_') ? 'UTR/Bank' : 'Ord'); ?>:</strong> <?php echo e($orderId); ?></small>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
