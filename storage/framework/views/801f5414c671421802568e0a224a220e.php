<?php $__env->startSection('title', 'Service Tracking - RC Search - SAHI GADI Admin'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-search me-2"></i>RC Search Tracking</h2>
</div>
...
<div class="card">
    <div class="card-header bg-white">
        <form action="<?php echo e(route('admin.service-tracking.vehicle-search')); ?>" method="GET" class="row g-2">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                ...
                <a href="<?php echo e(route('admin.service-tracking.vehicle-search')); ?>" class="btn btn-outline-secondary">Clear</a>
            </div>
        </form>
    </div>
            ...
            <table class="table table-modern mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($search->registration_number ?? $search->vehicle_number ?? 'N/A'); ?></td>
                        <td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/admin/service-tracking/vehicle-search.blade.php ENDPATH**/ ?>