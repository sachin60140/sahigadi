...
<?php $__env->startSection('title', 'Mahindra Service History - SAHI GADI'); ?>
<?php $__env->startSection('meta_description', 'Search mahindra vehicle service history online. Get complete service records from authorized mahindra service centers.'); ?>
        ...
        <div class="<?php echo e(auth('customer')->check() ? 'col-lg-9' : 'col-lg-8'); ?>">
            <div class="card border-0 shadow-lg <?php echo e(auth('customer')->check() ? 'rounded-4' : ''); ?>">
                ...
                <div class="card-body <?php echo e(auth('customer')->check() ? 'p-4' : ''); ?>">
                    <form action="<?php echo e(route('mahindra-service-history.search')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($record->is_success): ?>
                                                    <a href="<?php echo e(route('mahindra-service-history.show', $record->id)); ?>" class="btn btn-sm btn-outline-primary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/frontend/mahindra-service-history/index.blade.php ENDPATH**/ ?>