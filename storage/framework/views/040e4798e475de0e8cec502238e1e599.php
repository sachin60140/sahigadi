    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item text-white active" aria-current="page"><?php echo e($dealer->name); ?></li>
            </ol>
        </nav>
        <div class="text-white">
            <h1 class="fw-bold mb-2"><?php echo e($dealer->name); ?>'s Car Listings</h1>
            <p class="mb-0">Browse <?php echo e($cars->total()); ?> verified pre-owned cars from this dealer</p>
        </div>
    </div>
</section>
    ...
    <div class="row">
                    ...
                    <div class="card-body text-center p-4">
                        ...
                        <div class="d-flex flex-column gap-2 text-start mt-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="tel:<?php echo e($dealer->phone); ?>" class="text-decoration-none"><?php echo e($dealer->phone); ?></a>
                            </div>
                            <?php endif; ?>
                            <?php if($dealer->email): ?>
                            <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span><?php echo e($dealer->city); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                        <div class="mt-3 pt-3 border-top">
                            <span class="badge bg-accent px-3 py-2">
                                <i class="bi bi-car-front me-1"></i><?php echo e($cars->total()); ?> Listings
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <span class="badge bg-dark px-3 py-2"><?php echo e($cars->total()); ?> Cars Found</span>
                </div>
                <select class="form-select w-auto" onchange="window.location.href=this.value" style="min-width: 200px;">
                    <option value="<?php echo e(route('dealer.catalog', $dealer->slug)); ?>" <?php echo e(!request('sort') ? 'selected' : ''); ?>>Sort by: Relevance</option>
                    <option value="<?php echo e(route('dealer.catalog', array_merge([$dealer->slug], request()->except('sort'), ['sort' => 'newest']))); ?>" <?php echo e(request('sort') == 'newest' ? 'selected' : ''); ?>>Newest First</option>
                    <option value="<?php echo e(route('dealer.catalog', array_merge([$dealer->slug], request()->except('sort'), ['sort' => 'price_low']))); ?>" <?php echo e(request('sort') == 'price_low' ? 'selected' : ''); ?>>Price: Low to High</option>
                    <option value="<?php echo e(route('dealer.catalog', array_merge([$dealer->slug], request()->except('sort'), ['sort' => 'price_high']))); ?>" <?php echo e(request('sort') == 'price_high' ? 'selected' : ''); ?>>Price: High to Low</option>
                    <option value="<?php echo e(route('dealer.catalog', array_merge([$dealer->slug], request()->except('sort'), ['sort' => 'km_low']))); ?>" <?php echo e(request('sort') == 'km_low' ? 'selected' : ''); ?>>KM: Low to High</option>
                </select>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="card h-100">
                        <div class="position-relative">
                            <?php if($car->image_url): ?>
                                <img src="<?php echo e($car->image_url); ?>" class="card-img-top" alt="<?php echo e($car->title); ?>">
                            <?php else: ?>
                ...
                <div class="col-12 text-center py-5">
                    ...
                    <a href="<?php echo e(route('cars.index')); ?>" class="btn btn-accent">Browse All Cars</a>
                </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\frontend\cars\dealer-catalog.blade.php ENDPATH**/ ?>