<?php $__env->startSection('title', 'Customer Car Listings - SAHI GADI Admin'); ?>
...
<div class="top-bar d-flex justify-content-between align-items-center">
    ...
    <div>
        <a href="<?php echo e(route('admin.customer-listings.exportExcel')); ?>" class="btn btn-sm btn-success me-2">
            <i class="bi bi-file-earmark-excel"></i> Export Excel
        </a>
        <a href="<?php echo e(route('admin.customer-listings.exportPdf')); ?>" class="btn btn-sm btn-danger">
...
<div class="stat-card mb-4">
    <form action="<?php echo e(route('admin.customer-listings.index')); ?>" method="GET" class="row g-3">
        ...
        <div class="col-md-2">
            <input type="date" name="date" class="form-control" value="<?php echo e(request('date')); ?>" title="Filter by Date">
        </div>
        <div class="col-md-5">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    <?php if($listing->registration_number): ?>
                    <br>
                    <span class="badge bg-light text-dark border mt-1"><i class="bi bi-card-text me-1"></i><?php echo e($listing->registration_number); ?></span>
                    <?php endif; ?>
                </td>
                <td>
                    ...
                    <br>
                    <small class="text-muted"><i class="bi bi-telephone"></i> <?php echo e($listing->owner_phone); ?></small>
                </td>
