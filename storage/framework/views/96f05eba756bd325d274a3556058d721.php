...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
    <div>
        <h2 class="fw-bold mb-1 text-dark">Welcome back, <?php echo e(strtok(auth('dealer')->user()->name, ' ')); ?> 👋</h2>
        <p class="text-muted mb-0">Here's what's happening with your dealership inventory today.</p>
    </div>
    <div>
        <a href="<?php echo e(route('dealer.cars.create')); ?>" class="btn btn-primary px-4 py-2 fw-semibold rounded-pill shadow-sm"><i class="bi bi-plus-lg me-2"></i>Add New Car</a>
    </div>
</div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card border-0 shadow-sm rounded-4 hover-card h-100">
            <div class="card-body p-4">
                ...
                <h2 class="fw-bolder mb-0 text-dark display-6"><?php echo e($stats['total_cars']); ?></h2>
            </div>
        </div>
    </div>
    <!-- Stat 2 -->
    <div class="col-md-3 col-sm-6">
        <div class="card border-0 shadow-sm rounded-4 hover-card h-100">
            <div class="card-body p-4">
                ...
                <h2 class="fw-bolder mb-0 text-dark display-6"><?php echo e($stats['approved_cars']); ?></h2>
            </div>
        </div>
    </div>
    <!-- Stat 3 -->
    <div class="col-md-3 col-sm-6">
        <div class="card border-0 shadow-sm rounded-4 hover-card h-100">
            <div class="card-body p-4">
                ...
                <h2 class="fw-bolder mb-0 text-dark display-6"><?php echo e($stats['pending_cars']); ?></h2>
            </div>
        </div>
    </div>
    <!-- Stat 4 -->
    <div class="col-md-3 col-sm-6">
        <div class="card border-0 shadow-sm rounded-4 hover-card h-100">
            <div class="card-body p-4">
                ...
                <h2 class="fw-bolder mb-0 text-dark display-6"><?php echo e($stats['new_enquiries']); ?></h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); color: white;">
            ...
            <div class="card-body p-4 d-flex flex-column justify-content-between position-relative z-1">
                <div>
                    ...
                    <h1 class="fw-bold mb-0 display-5">₹<?php echo e(number_format($stats['wallet_balance'], 2)); ?></h1>
                </div>
                <div class="mt-4 pt-3 border-top border-white border-opacity-25">
                    <a href="<?php echo e(route('dealer.wallet.index')); ?>" class="text-white text-decoration-none fw-semibold d-flex align-items-center justify-content-between">
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100 hover-card">
                    <div class="card-body p-4 text-center d-flex flex-column justify-content-center">
                        <div class="mb-3">
                            ...
                            <h2 class="fw-bold text-dark mb-0"><?php echo e($stats['remaining_listings']); ?></h2>
                        </div>
                        <div class="mt-2"><a href="<?php echo e(route('dealer.plans.index')); ?>" class="btn btn-outline-primary btn-sm rounded-pill px-4 fw-semibold">Upgrade Plan</a></div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card border-0 shadow-sm rounded-4 h-100 hover-card">
                    <div class="card-body p-4 text-center d-flex flex-column justify-content-center">
                        <div class="mb-3">
                            <?php $status = auth('dealer')->user()->status; ?>
                            <div class="icon-shape mx-auto mb-3 <?php echo e($status === 'approved' ? 'bg-success bg-opacity-10 text-success' : ($status === 'pending' ? 'bg-warning bg-opacity-10 text-warning' : 'bg-danger bg-opacity-10 text-danger')); ?>" style="width: 64px; height: 64px;">
                                <i class="bi <?php echo e($status === 'approved' ? 'bi-shield-check' : ($status === 'pending' ? 'bi-shield-exclamation' : 'bi-shield-x')); ?> fs-2"></i>
                            </div>
                            <h6 class="text-muted mb-1 fw-semibold text-uppercase" style="font-size: 0.8rem;">Showroom Status</h6>
                            <h3 class="fw-bold text-dark mb-0 text-capitalize"><?php echo e($status); ?></h3>
                        </div>
                        <div class="mt-2">
            ...
            <div class="card-body p-4">
                ...
                <div class="mt-4 bg-light p-2 rounded-pill border">
                    <div class="input-group">
                        <input type="text" class="form-control bg-transparent border-0 ps-4 shadow-none fw-medium text-dark" id="catalogUrl" value="<?php echo e(url('/catalog/' . auth('dealer')->user()->slug)); ?>" readonly>
        ...
        <div class="card shadow-sm rounded-4 border-0 h-100 bg-dark text-white text-center position-relative overflow-hidden">
            ...
            <div class="card-body p-4 position-relative z-1 d-flex flex-column justify-content-center">
                ...
                <div class="d-flex justify-content-center align-items-center gap-4 mt-2">
                    <div class="px-3">
                        <h1 class="display-4 fw-bold mb-0"><?php echo e(auth('dealer')->user()->cars()->where('is_active', true)->where('status', 'approved')->count()); ?></h1>
                    ...
                    <div class="px-3">
                        <h1 class="display-4 fw-bold mb-0 text-warning"><?php echo e(auth('dealer')->user()->cars()->where('is_active', true)->where('status', 'pending')->count()); ?></h1>
...
<div class="card border-0 shadow-sm rounded-4 mb-4">
    <div class="card-header bg-white border-bottom pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
        ...
        <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3"><?php echo e($recentEnquiries->count()); ?> Leads</span>
    </div>
    <div class="card-body p-0">
            ...
            <table class="table table-hover align-middle mb-0 border-white">
                ...
                <tbody class="border-top-0">
                    ...
                    <tr style="transition: all 0.2s;">
                        <td class="ps-4 py-3">
                            <div class="d-flex align-items-center">
                                <div class="bg-primary bg-opacity-10 text-primary fw-bold rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px;">
                                    <?php echo e(strtoupper(substr($enquiry->customer_name, 0, 1))); ?>

                                </div>
                                <span class="fw-semibold text-dark"><?php echo e($enquiry->customer_name); ?></span>
                            </div>
                        </td>
                        <td class="py-3">
                            <a href="<?php echo e(route('dealer.cars.edit', $enquiry->car_id)); ?>" class="text-decoration-none fw-semibold text-primary d-flex align-items-center">
                                <i class="bi bi-car-front me-2 text-muted"></i>
                                <?php echo e(Str::limit($enquiry->car->title ?? 'Deleted Car', 30)); ?>

                            </a>
                        </td>
                        <td class="py-3 text-muted fw-medium"><i class="bi bi-telephone-fill small me-2 opacity-50"></i><?php echo e($enquiry->customer_phone); ?></td>
                        <td class="py-3">
                        ...
                        <td class="py-3 pe-4 text-end text-muted small fw-medium"><?php echo e($enquiry->created_at->format('M d, Y')); ?></td>
                    </tr>
        ...
        <div class="text-center py-5 text-muted">
            ...
            <a href="<?php echo e(route('dealer.cars.create')); ?>" class="btn btn-outline-primary rounded-pill mt-2">List a New Car</a>
        </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.dealer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\dealer\dashboard.blade.php ENDPATH**/ ?>