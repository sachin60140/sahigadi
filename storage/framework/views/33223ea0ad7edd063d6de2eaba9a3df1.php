...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Dealer Dashboard for SAHI GADI'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', 'Dealer Dashboard - SAHI GADI'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'Dealer Dashboard for SAHI GADI'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('twitter_title', 'Dealer Dashboard - SAHI GADI'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('twitter_description', 'Dealer Dashboard for SAHI GADI'); ?>">
...
<body>
            ...
            <div class="col-md-2 sidebar p-0 offcanvas-md offcanvas-start" tabindex="-1" id="dealerSidebar" aria-labelledby="dealerSidebarLabel">
                ...
                <div class="offcanvas-body p-0 flex-column">
                    <div class="sidebar-brand text-center d-none d-md-flex flex-column align-items-center">
                        ...
                        <h5 class="mb-0 fw-bold"><?php echo e(Auth::guard('dealer')->user()->name ?? 'Dealer'); ?></h5>
                        <small class="text-muted mt-1">+91 <?php echo e(Auth::guard('dealer')->user()->phone); ?></small>
                        <span class="badge bg-secondary mt-2">ID: <?php echo e(Auth::guard('dealer')->user()->dealer_unique_id); ?></span>
                    </div>
                    ...
                    <a href="<?php echo e(route('dealer.challan-pdf.index')); ?>" class="<?php echo e(request()->routeIs('dealer.challan-pdf.*') ? 'active' : ''); ?>">
    ...
    <?php echo $__env->make('partials.global_loader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
