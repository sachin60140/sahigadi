...
<head>
    <meta charset="UTF-8">
    <title>Wallet Recharge Receipt - <?php echo e($transaction->id); ?> - SAHI GADI</title>
    <style>
...
<body>
    ...
    <div class="section">
        ...
        <p>
            <strong>Customer ID:</strong> <?php echo e($customer->customer_unique_id ?? 'N/A'); ?><br>
            <strong>Customer Name:</strong> <?php echo e($customer->name ?? 'N/A'); ?><br>
            <strong>Company Name:</strong> <?php echo e($customer->company_name ?? 'N/A'); ?><br>
            <strong>Address:</strong> <?php echo e($customer->address ?? 'N/A'); ?><br>
            <strong>City:</strong> <?php echo e($customer->city ?? 'N/A'); ?><br>
            <strong>State:</strong> <?php echo e($customer->state ?? 'N/A'); ?><br>
            <strong>Pincode:</strong> <?php echo e($customer->pincode ?? 'N/A'); ?><br>
            <strong>Phone:</strong> <?php echo e($customer->phone); ?><br>
             <strong>Email:</strong> <?php echo e($customer->email); ?><br>
            <strong>GST Number:</strong> <?php echo e($customer->gst_number ?? 'N/A'); ?>
...
<?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\frontend\customer\wallet\receipt-pdf.blade.php ENDPATH**/ ?>