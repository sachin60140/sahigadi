...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('price')); ?>" min="0" step="0.01" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('listing_limit')); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('duration_days')); ?>" min="1" required>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\admin\plans\create.blade.php ENDPATH**/ ?>