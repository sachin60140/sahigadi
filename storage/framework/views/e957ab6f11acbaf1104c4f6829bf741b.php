                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <select name="kyc_document_type" class="form-select">
                            ...
                            <option value="aadhar" <?php echo e(old('kyc_document_type', $dealer->kyc_document_type) == 'aadhar' ? 'selected' : ''); ?>>Aadhaar Card</option>
                            <option value="pan" <?php echo e(old('kyc_document_type', $dealer->kyc_document_type) == 'pan' ? 'selected' : ''); ?>>PAN Card</option>
                            <option value="voter_id" <?php echo e(old('kyc_document_type', $dealer->kyc_document_type) == 'voter_id' ? 'selected' : ''); ?>>Voter ID</option>
                            <option value="driving_license" <?php echo e(old('kyc_document_type', $dealer->kyc_document_type) == 'driving_license' ? 'selected' : ''); ?>>Driving License</option>
                        </select>
                    </div>
                    <div class="col-md-6">
