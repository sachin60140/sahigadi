<?php $__env->startSection('title', 'RC Search Settings - SAHI GADI Admin'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-gear me-2"></i>RC Search Settings</h2>
    <a href="<?php echo e(route('admin.vehicle-searches.index')); ?>" class="btn btn-outline-secondary">
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.vehicle-searches.settings')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/admin/vehicle-searches/settings.blade.php ENDPATH**/ ?>