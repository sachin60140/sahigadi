                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                ...
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" id="is_razorpay_active" name="is_razorpay_active" <?php echo e($isRazorpayActive ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="is_razorpay_active">Enable Razorpay</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" id="is_phonepe_active" name="is_phonepe_active" <?php echo e($isPhonePeActive ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="phonepe_merchant_id" class="form-control" 
                                    value="<?php echo e(old('phonepe_merchant_id', $phonePeMerchantId)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" name="phonepe_salt_key" class="form-control" 
                                    value="<?php echo e(old('phonepe_salt_key', $phonePeSaltKey)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">PhonePe Salt Index</label>
                                <input type="text" name="phonepe_salt_index" class="form-control" 
                                    value="<?php echo e(old('phonepe_salt_index', $phonePeSaltIndex)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Environment</label>
                                <select name="phonepe_env" class="form-control" required>
                                    <option value="UAT" <?php echo e(old('phonepe_env', $phonePeEnv) === 'UAT' ? 'selected' : ''); ?>>UAT (Testing)</option>
                                    <option value="PRODUCTION" <?php echo e(old('phonepe_env', $phonePeEnv) === 'PRODUCTION' ? 'selected' : ''); ?>>PRODUCTION</option>
                                </select>
                            </div>
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="url" name="phonepe_checkout_url" class="form-control" 
                                    value="<?php echo e(old('phonepe_checkout_url', $phonePeCheckoutUrl)); ?>" placeholder="e.g. https://api.phonepe.com/apis/pg/checkout/v2/pay">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="min_wallet_recharge_amount" class="form-control" 
                                    value="<?php echo e(old('min_wallet_recharge_amount', $minRechargeAmount)); ?>" min="1" step="0.01" required>
