...
<body>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr><td><strong>Amount Charged</strong></td><td>Rs.<?php echo e(number_format($marutiServiceHistory->debit_amount ?? 0, 2)); ?></td></tr>
        </table>
    </div>
    <?php else: ?>
    <div class="section">
...
</html><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\dealer\maruti-service-history\pdf.blade.php ENDPATH**/ ?>