...
<body>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr><td><strong>Amount Charged</strong></td><td>Rs.<?php echo e(number_format($serviceHistory->debit_amount, 2)); ?></td></tr>
        </table>
    </div>
    <?php else: ?>
    <div class="section">
...
<?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\dealer\service-history\pdf.blade.php ENDPATH**/ ?>