...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('admin.cars.update', $car)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="dealer_id" class="form-select <?php $__errorArgs = ['dealer_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="<?php echo e($dealer->id); ?>" <?php echo e(old('dealer_id', $car->dealer_id) == $dealer->id ? 'selected' : ''); ?>><?php echo e($dealer->name); ?> (<?php echo e($dealer->email); ?>)</option>
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="pending" <?php echo e(old('status', $car->status) == 'pending' ? 'selected' : ''); ?>>Pending</option>
                            <option value="approved" <?php echo e(old('status', $car->status) == 'approved' ? 'selected' : ''); ?>>Approved</option>
                            <option value="rejected" <?php echo e(old('status', $car->status) == 'rejected' ? 'selected' : ''); ?>>Rejected</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('admin.cars.index')); ?>" class="btn btn-secondary">Cancel</a>
        </form>
            ...
            <div class="d-flex flex-wrap gap-3 mt-3">
                ...
                <div class="position-relative border p-2 rounded bg-light">
                    ...
                    <div class="mt-2 d-flex gap-1 justify-content-center">
                        <form action="<?php echo e(route('admin.cars.image.primary', [$car, $image])); ?>" method="POST" class="d-inline">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-sm btn-outline-primary" <?php echo e($image->is_primary ? 'disabled' : ''); ?>>Primary</button>
                        </form>
                        <form action="<?php echo e(route('admin.cars.image.delete', [$car, $image])); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this image?')">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\admin\cars\edit.blade.php ENDPATH**/ ?>