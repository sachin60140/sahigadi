    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="mt-5 p-4 bg-light rounded shadow-sm border">
                <h2 class="h4 fw-bold text-dark mb-3">Buy Used <?php echo e($brandName); ?> Cars<?php echo e($cityName ? ' in ' . $cityName : ''); ?></h2>
                <p class="text-muted">
                    Searching for reliable <strong>used <?php echo e($brandName); ?> cars<?php echo e($cityName ? ' in ' . $cityName : ''); ?></strong>? Your search ends here. SAHIGADI brings to you an exclusively verified collection of pre-owned <?php echo e($brandName); ?> vehicles. Known for their build quality, reliable engines, and great resale value, <?php echo e($brandName); ?> cars are a favorite among buyers. 
                </p>
                <p class="text-muted mb-0">
                    Filter your search by price, model, and year to find the perfect <strong>second hand <?php echo e($brandName); ?> car<?php echo e($cityName ? ' in ' . $cityName : ''); ?></strong>. We make sure every listing passes thorough inspections, ensuring our buyers get nothing but the best. Skip the hassle of unverified sellers and grab the best deals with easy RC transfer and financing support today.
                </p>
            </div>
        </div>
    </div>
