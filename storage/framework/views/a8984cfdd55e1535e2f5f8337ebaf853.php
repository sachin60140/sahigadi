<?php $__env->startSection('title', 'Get Service History - SAHIGADI'); ?>
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="fw-bold mt-3">Mahindra Vehicle Service History</h2>
                        <p class="text-muted">Enter your vehicle details to get complete service records from authorized service centers</p>
                    </div>

                    <form action="<?php echo e(route('service-history.search')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-accent w-100 py-3">
                            <i class="bi bi-search me-2"></i>Search Service History
                        </button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/frontend/service-history/index.blade.php ENDPATH**/ ?>