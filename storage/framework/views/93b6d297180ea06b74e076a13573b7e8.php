            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-1">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('maruti-service-history.index')); ?>">Maruti Service History</a></li>
                            <li class="breadcrumb-item active"><?php echo e($marutiServiceHistory->vehicle_number); ?></li>
                        </ol>
                    </nav>
                    <h2><i class="bi bi-car-front-fill me-2"></i><?php echo e($marutiServiceHistory->vehicle_number); ?></h2>
                </div>
                <div class="d-flex gap-2">
                    <?php if($marutiServiceHistory->is_success): ?>
                        ...
                        <a href="<?php echo e(route('maruti-service-history.pdf', $marutiServiceHistory)); ?>" class="btn btn-danger">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\frontend\maruti-service-history\show.blade.php ENDPATH**/ ?>