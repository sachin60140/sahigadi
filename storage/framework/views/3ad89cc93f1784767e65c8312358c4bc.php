            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body p-5 text-center">
                    ...
                    <p class="text-muted mb-4">
                        Vehicle: <strong><?php echo e($registrationNumber); ?></strong>
                    </p>

                    <div class="alert alert-light border mb-4">
                        <h4 class="mb-0">₹<?php echo e(number_format($amount, 0)); ?></h4>
                        <small class="text-muted">RC Search Report</small>
                    </div>

                    <form id="payment-form" action="<?php echo e(route('vehicle-search.callback')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<script>
    const options = {
        ...
        "currency": "INR",
        "name": "SAHIGADI",
        "description": "RC Search - <?php echo e($registrationNumber); ?>",
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\frontend\vehicle-search\payment.blade.php ENDPATH**/ ?>