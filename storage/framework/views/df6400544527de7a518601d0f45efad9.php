            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <span class="badge bg-secondary">Customer ID: <?php echo e(auth()->guard('customer')->user()->customer_unique_id); ?></span>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card bg-success text-white border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <h2 class="fw-bold mb-0">₹<?php echo e(number_format($balance, 2)); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if((str_contains(strtolower($transaction->remark), 'recharge via razorpay') || str_contains(strtolower($transaction->remark), 'recharge via phonepe') || str_contains(strtolower($transaction->remark), 'recharge via')) && $transaction->type === 'credit'): ?>
                                <br>
                                <a href="<?php echo e(route('customer.wallet.receipt', $transaction->id)); ?>" class="btn btn-sm btn-outline-primary mt-1" style="font-size: 0.75rem; padding: 2px 6px;">
...
<div class="modal fade" id="rechargeModal" tabindex="-1" aria-labelledby="rechargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(route('customer.payments.checkout')); ?>" method="GET" id="rechargeForm">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <?php if(session('open_recharge_modal')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/frontend/customer/wallet/index.blade.php ENDPATH**/ ?>