<?php $__env->startSection('title', 'Manage Dealers - SAHIGADI Admin'); ?>
...
<div class="stat-card mb-4">
    <form action="<?php echo e(route('admin.dealers.index')); ?>" method="GET" class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <a href="<?php echo e(route('admin.dealers.index')); ?>" class="btn btn-outline-secondary">Clear</a>
        </div>
    </form>
</div>
    ...
    <table class="table table-modern mb-0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('admin.dealers.show', $dealer)); ?>" class="btn btn-sm btn-outline-primary me-1">
                        <i class="bi bi-eye"></i>
                    </a>
                    <?php if($dealer->status === 'pending'): ?>
                    <form action="<?php echo e(route('admin.dealers.approve', $dealer)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
