...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item has-submenu <?php echo e(request()->routeIs('admin.challan-searches.*') || request()->routeIs('admin.challan-pdf.*') || request()->routeIs('admin.service-tracking.challan-search') ? 'active' : ''); ?>">
                <a href="#" class="nav-link" onclick="toggleSubmenu(this); return false;">
                ...
                <div class="submenu">
                    ...
                    <a href="<?php echo e(route('admin.challan-pdf.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.challan-pdf.*') ? 'active' : ''); ?>">
