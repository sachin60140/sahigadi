<?php $__env->startSection('title', 'Browse Used Cars - SAHIGADI'); ?>
<?php $__env->startSection('meta_title', 'Browse Used Cars - Pre-Owned Cars Marketplace in Bihar | SAHIGADI'); ?>
                    ...
                    <div class="card h-100">
                        <div class="position-relative">
                            ...
                            <?php if(count($images) > 0): ?>
                                <img src="<?php echo e(asset('storage/' . $images[0])); ?>" class="card-img-top" alt="<?php echo e($listing->title); ?>">
                            <?php else: ?>
                                <div class="bg-light d-flex align-items-center justify-content-center" style="height: 200px;">
                                    <i class="bi bi-car-front text-secondary" style="font-size: 4rem;"></i>
                                </div>
