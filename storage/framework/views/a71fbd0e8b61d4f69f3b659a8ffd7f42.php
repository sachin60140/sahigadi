<?php $__env->startSection('title', 'View Listing - ' . $listing->title . ' - SAHI GADI Admin'); ?>
...
<div class="top-bar">
    ...
    <div class="d-flex gap-2 flex-wrap">
        <a href="<?php echo e(route('admin.customer-listings.edit', $listing->slug)); ?>" class="btn btn-outline-primary">
