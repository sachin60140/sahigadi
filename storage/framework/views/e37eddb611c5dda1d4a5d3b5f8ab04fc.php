...
# <?php echo e($details['is_admin'] ? 'New Featured Plan Subscription' : 'Featured Plan Subscribed Successfully'); ?>
...
**Plan Details:**
* **Plan Name:** <?php echo e($details['plan_name']); ?> (<?php echo e($details['duration_days']); ?> Days)
* **Amount Paid:** ₹<?php echo e(number_format($details['amount_paid'], 2)); ?>

* **Valid Until:** <?php echo e(\Carbon\Carbon::parse($details['expires_at'])->format('d M Y, h:i A')); ?>
...
<?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\emails\featured\subscribed.blade.php ENDPATH**/ ?>