<?php $__env->startSection('title', 'Sell Your Used Car Online In India - Best Market Price | SAHI GADI'); ?>
<?php $__env->startSection('meta_description', 'Looking to sell your car in Bihar, Patna, or anywhere in India? List your second-hand car on SAHI GADI for free valuation, instant payout, and hassle-free RC transfer.'); ?>
...
unset($__errorArgs, $__bag); ?>
                                            <?php $__currentLoopData = $errors->keys(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(\Illuminate\Support\Str::startsWith($key, 'images.')): ?>
                                                    <div class="text-danger small mt-1"><?php echo e($errors->first($key)); ?></div>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <div class="mt-2">
...
unset($__errorArgs, $__bag); ?>" 
                                                   placeholder="10-digit phone number" value="<?php echo e(old('owner_phone')); ?>" required pattern="[0-9]{10}" inputmode="numeric" autocomplete="tel">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if(session('sell_car_phone_verified') === old('owner_phone') && old('owner_phone') != ''): ?>
