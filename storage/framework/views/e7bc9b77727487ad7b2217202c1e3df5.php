            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body p-5 text-center">
                    ...
                    <div class="alert alert-light border mb-4">
                        ...
                        <small class="text-muted">E-Challan Report</small>
                    </div>

                    <form id="payment-form" action="<?php echo e(route('challan-search.callback')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<script>
    const options = {
        ...
        "currency": "INR",
        "name": "SAHIGADI",
        "description": "E-Challan Check - <?php echo e($vehicleNumber); ?>",
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\frontend\challan-search\payment.blade.php ENDPATH**/ ?>