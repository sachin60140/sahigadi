                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('vehicle-search.index')); ?>" class="btn btn-sm btn-outline-primary mt-2">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('service-history.index')); ?>" class="btn btn-sm btn-outline-primary mt-2">
                                    <i class="bi bi-arrow-right me-1"></i>Check Now
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('challan-search.index')); ?>" class="btn btn-sm btn-outline-primary mt-2">
                                    <i class="bi bi-arrow-right me-1"></i>Check Now
                                </a>
                            </div>
                        </div>
