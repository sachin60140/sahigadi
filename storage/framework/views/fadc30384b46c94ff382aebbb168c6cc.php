...
<head>
    <meta charset="UTF-8">
    <title>E-Challan Report - <?php echo e($challanSearch->vehicle_number); ?> - SAHI GADI</title>
    <style>
...
<body>
    ...
    <div class="footer">
        <strong>SAHI GADI</strong> - Vehicle Marketplace | Generated on: <?php echo e(date('d M Y, h:i A')); ?>
