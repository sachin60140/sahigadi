        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('dealer.challan-pdf.history')); ?>" class="btn btn-sm btn-light">View History</a>
                </div>
                <div class="card-body">

                    <div class="alert alert-info">
                        <strong>Note:</strong> Charge per search is ₹<?php echo e(\App\Models\Setting::getDealerChallanPdfCharge()); ?>. 
                        Amount will be deducted from your wallet only on successful PDF generation.
                    </div>

                    <form action="<?php echo e(route('dealer.challan-pdf.search')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.dealer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views/dealer/challan_pdf/index.blade.php ENDPATH**/ ?>