...
<body>
    ...
    <div class="header">
        ...
        <span class="badge badge-success"><?php echo e($marutiServiceHistory->service_count ?? 0); ?> Services Found</span>
    </div>

    <?php if($marutiServiceHistory->is_success && $dealerSearch): ?>
    <div class="section">
    ...
    <div class="section">
        ...
        <table>
            <tr><td class="label">Dealer</td><td><?php echo e($marutiServiceHistory->dealer->name ?? 'N/A'); ?></td></tr>
            <tr><td class="label">Search Date</td><td><?php echo e($marutiServiceHistory->created_at->setTimezone('Asia/Kolkata')->format('d M Y, h:i A')); ?></td></tr>
            <tr><td class="label">Amount Charged</td><td>Rs.<?php echo e(number_format($marutiServiceHistory->charge_amount, 2)); ?></td></tr>
        </table>
    </div>
    <?php else: ?>
    <div class="section">
        <div class="section-title">Error</div>
        <p><?php echo e($marutiServiceHistory->error_message ?? 'Search failed'); ?></p>
    </div>
    <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\sahigadi-ai\resources\views\admin\maruti-service-histories\single-pdf.blade.php ENDPATH**/ ?>